...
export default function Home() {
  ...
  return (
    <div>
      <header>
        <Info>
          <p className="country">País: <span>{emoji_flag}</span></p>
          <p className="latitude">Latitude: <span>{lat}</span></p>
          <p className="longitude">Longitude: <span>{lng}</span></p>
        </Info>

        <Menu>
          <Link href="/">
            <a target="_self" className='nameOfWebsite'>IPadress</a>
          </Link>
        </Menu>
      </header>
